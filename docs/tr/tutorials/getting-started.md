...
JSON kalıcılığı, reklam veya analitik desteği için isteğe bağlı modülleri de ekleyin — Git URL'lerinin tam listesi için [VGameKit Modülleri Nasıl Kurulur](../how-to/install-modules.md) rehberine bakın.
...
- [Tutorial: İlk mini oyununuzu oluşturun](./first-game.md)
- [Nasıl yapılır: Logging yapılandırma](../how-to/configure-logging.md)
